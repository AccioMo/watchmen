        ...
        <div className="min-h-screen bg-[#0d0d0d] text-white pt-24 px-6 md:px-12">
            <div className="max-w-4xl m-auto space-y-8">
                ...
                <div className="space-y-6 text-lg text-white/80 leading-relaxed font-light">
                    <p>
                        <strong>N4tflix</strong> does not host any files on its servers. All content is provided by non-affiliated third parties.
                    </p>

                    <p>
                        <strong>N4tflix</strong> does not accept responsibility for content hosted on third-party websites and does not have any involvement in the downloading/uploading of movies. We just act as a search engine indexer gathering links already available on the internet.
                    </p>
                    ...
                    <div className="p-4 bg-white/5 border border-white/10 rounded-xl mt-8">
                        <p className="text-sm text-white/60">
                            By using this site, you agree to this disclaimer and acknowledge that <strong>N4tflix</strong> is not liable for any third-party content.
                        </p>
                    </div>
                </div>
            </div>
