		...
		<>
			<div className={`${fixed ? 'fixed top-0 w-full ' : ''}h-[132px] py-4 px-8 z-50`}>
				<div className="flex h-full w-full justify-between items-center px-4 py-4">
					<div className="flex glass-card glass-border rounded-full w-[130px]">
						<div 
					...
					<div className="flex glass-card glass-border rounded-full">
						<ul className="flex justify-center items-center gap-4 px-8">
							<li className="text-white px-12 cursor-pointer opacity-50 hover:opacity-100 transition-opacity duration-200" onClick={() => router.push("/top")}>Top Rated</li>
					...
					<div className="flex glass-card glass-border rounded-full w-[130px] group">
						<div 
